...
public class UpdateResult extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{ 
            ...
            UserDataDTO nudd = new UserDataDTO();
            nudd.setUserID(udd.getUserID());
            udb.UD2DTOMapping(nudd);
            
            UserDataDAO.getInstance().update(nudd);
        
            request.setAttribute("resultData", nudd);
