...
<html>
    ...
    <form action="insertconfirm" method="POST">
        ...
        種別:
        <br>
        <input type="radio" name="type" value="1" <%if(udb==null){out.print("checked");}else if(udb.getType()==1){out.print("checked");}%>>エンジニア<br>
        ...
        電話番号:
        <input type="tel" name="tell" value="<%if(udb!=null){out.print(udb.getTell());}%>">
        <br><br>
